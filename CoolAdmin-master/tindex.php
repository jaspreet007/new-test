    ...
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
		 ...
		 $res=mysqli_query($con,$str);
			...
			{
			echo"	<a href='manage_tpassword.php'?id=".$result['id']."'>".$result['user_name']."</br>".$result['login_url']."</a>";
			//echo"<li><a href='manage_edit.php'?id=".$result['id']."'>".$result['user_name']." </br>".$result['login_url']."</a></li>";
			}
...
$notes=$_POST['notes'];
$str="insert into add_user(user_name,login_url,password,notes)values('$user_name','$login_url','$password','$notes')";
...
<body>
    ...
    <div id="autofill-detected" style="display:none" class="alert alert-warning">Warning: Your browser is set to autofill, which will overwrite shared account information. <a href="https://support.jungledisk.com/hc/en-us/articles/360003299994" alt="Disable Browser Autofill" target="_blank">Learn how to disable autofill for TeamPassword.</a></div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input id="account_name" class="form-control" name="name" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="" autofocus="" required="">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input id="url" name="login_url" class="form-control" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="" required="">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input id="account_username" class="form-control fixed-width-font" type="text" name="user_name" autocomplete="new-password" autocorrect="off" autocapitalize="off" spellcheck="false" value="" required="">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <div class="input-group">
            <input id="account_password" class="form-control fixed-width-font" name="password" type="password" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" value="" required="">
